...
ToggleMaptileDecorations:
	...
	lb de, 4, 4 ; carpet top-left coordinates
	call PadCoords_de
	ld a, [wDecoCarpet]
	and a
	ret z
	...
	ld [hl], a
	push af
	lb de, 6, 4 ; carpet bottom-left coordinates
	call PadCoords_de
	pop af
	inc a
	ld [hli], a ; carpet top-right block
	inc a
