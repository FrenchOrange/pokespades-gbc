...
.PC_ElmsLab_OAM:
	dbsprite   7,   5, 2, 0, $7c, PAL_OW_TREE | OBP_NUM
	dbsprite   7,   5, 6, 0, $7c, PAL_OW_TREE | OBP_NUM
	dbsprite   7,   5, 0, 6, $7d, PAL_OW_TREE | OBP_NUM
	dbsprite   8,   5, 0, 6, $7d, PAL_OW_TREE | OBP_NUM | X_FLIP
	dbsprite   7,   6, 0, 3, $7d, PAL_OW_TREE | OBP_NUM
	dbsprite   8,   6, 0, 3, $7d, PAL_OW_TREE | OBP_NUM | X_FLIP
	dbsprite   7,   7, 0, 0, $7d, PAL_OW_TREE | OBP_NUM
	dbsprite   8,   7, 0, 0, $7d, PAL_OW_TREE | OBP_NUM | X_FLIP
