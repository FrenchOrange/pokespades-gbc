...
StdScripts::
	...
	add_stdscript FridgeScript
	add_stdscript StoveScript
	add_stdscript TablewareScript
...
InitializeEventsScript:
	...
	setevent EVENT_LOTUS_TOWN_MOM
	setevent EVENT_CLERK_VISIBLE_IN_APRICOT
; Vanilla
