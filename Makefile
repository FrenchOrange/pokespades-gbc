...
$(foreach obj, $(pokespades_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
...
pokespades_opt          = -Cjv -t PM_CRYSTAL -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
...
gfx/sprites/big_chansey.2bpp: tools/gfx += --remove-whitespace
