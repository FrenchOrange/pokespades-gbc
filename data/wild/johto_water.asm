...
JohtoWaterWildMons:
	...
	def_water_wildmons SERENITY_FOREST
	db 2 percent ; encounter rate
	db 15, PSYDUCK
	db 10, PSYDUCK
	db 15, GOLDUCK
	...
	def_water_wildmons HOLLOWED_CAVERN
	db 2 percent ; encounter rate
	db 15, MAGIKARP
	db 10, MAGIKARP
	db 5, MAGIKARP
	...
	def_water_wildmons APRICOT_TOWN
	db 6 percent ; encounter rate
	db 20, TENTACOOL
	db 15, TENTACOOL
	db 20, TENTACRUEL
