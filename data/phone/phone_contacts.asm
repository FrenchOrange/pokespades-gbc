...
; entries correspond to PHONE_* constants
	...
	phone TRAINER_NONE, PHONECONTACT_MOM,      N_A,                       ANYTIME, MomPhoneCalleeScript,     0,       UnusedPhoneScript
	...
	phone YOUNGSTER,    BILLY,                 N_A,                       ANYTIME, JoeyPhoneCalleeScript,    ANYTIME, JoeyPhoneCallerScript
	phone BUG_CATCHER,  JACOB,                 N_A,                       ANYTIME, WadePhoneCalleeScript,    ANYTIME, WadePhoneCallerScript
	...
	phone HIKER,        ANTOINE2,              N_A,                       ANYTIME, AnthonyPhoneCalleeScript, ANYTIME, AnthonyPhoneCallerScript
	...
	phone FISHER,       TULLY1,                N_A,                       ANYTIME, TullyPhoneCalleeScript,   ANYTIME, TullyPhoneCallerScript
