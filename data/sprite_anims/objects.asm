...
; SPRITE_ANIM_OBJ_MAGNET_TRAIN_PINK
	db SPRITE_ANIM_FRAMESET_MAGNET_TRAIN_PINK,         SPRITE_ANIM_FUNC_NULL,                      SPRITE_ANIM_DICT_DEFAULT
...
; SPRITE_ANIM_INDEX_PINK_WALK
	db SPRITE_ANIM_FRAMESET_PINK_WALK,                 SPRITE_ANIM_FUNC_NULL,                      SPRITE_ANIM_DICT_DEFAULT
