...
; Johto story events
	const EVENT_GOT_LOTUS_TOWN_LAVA_COOKIE
	const EVENT_GOT_A_POKEMON_FROM_CYPRESS
	const EVENT_GOT_CYNDAQUIL_FROM_ELM
	const EVENT_GOT_TOTODILE_FROM_ELM
	const EVENT_GOT_CHIKORITA_FROM_ELM
	const EVENT_ROAD_A01_RIVAL_BATTLE
	const EVENT_GOT_QUICK_CLAW_FROM_TRAINER_SCHOOL
; Vanilla
...
; Johto hidden items
	const EVENT_ROAD_A00_HIDDEN_PEARL
	const EVENT_ROAD_A02_HIDDEN_ANTIDOTE
	const EVENT_ROAD_A02_HIDDEN_POKE_BALL
	const EVENT_ROAD_A03_HIDDEN_POTION
	const EVENT_SERENITY_FOREST_HIDDEN_SUPER_POTION
	const EVENT_ROAD_A04_HIDDEN_POKE_BALL
	const EVENT_TRAINER_SCHOOL_POKE_BALL
; Vanilla
...
; Decorations
	...
	const EVENT_DECO_BIG_CHANSEY_DOLL
...
; Twins
	const EVENT_BEAT_TWINS_APRIL_AND_MAY ; Road A04
	const EVENT_BEAT_TWINS_APRIL_AND_MAY2 ; Road A04
...
; Lass
	const EVENT_BEAT_LASS_RAMONA ; Road A02
	const EVENT_BEAT_LASS_SOPHIA ; Road A04
...
; Bug Catcher
	const EVENT_BEAT_BUG_CATCHER_JACOB ; Road A03
	const EVENT_BEAT_BUG_CATCHER_TIM ; Road A02
	const EVENT_BEAT_BUG_CATCHER_PETER ; Serenity Forest
	const EVENT_BEAT_BUG_CATCHER_NATHAN ; Serenity Forest
	const EVENT_BEAT_BUG_CATCHER_REEVE ; Serenity Forest
...
; Youngster
	const EVENT_BEAT_YOUNGSTER_BILLY ; Road A03
	const EVENT_BEAT_YOUNGSTER_JASON ; Road A02
	const EVENT_BEAT_YOUNGSTER_MATT ; Serenity Forest
	const EVENT_BEAT_YOUNGSTER_ANTHONY ; Serenity Forest
	const EVENT_BEAT_YOUNGSTER_TONY ; Magnolia Gym
	...
	const_skip ; unused
; Lady
	const EVENT_BEAT_LADY_STACY ; Road A04
	const_skip ; unused
	const_skip ; unused
...
; Johto itemballs
	...
	const EVENT_ROAD_A00_RARE_CANDY
	const EVENT_ROAD_A01_POTION
	const EVENT_ROAD_A04_PARALYZHEAL
; Vanilla
...
; Johto people
	...
	const EVENT_LOTUS_TOWN_MOM
	const EVENT_LOTUS_TOWN_SUPER_NERD
	const EVENT_ROAD_A00_PROF
	const EVENT_ROAD_A00_RIVAL
	const EVENT_ROAD_A00_BAG
	const EVENT_CLERK_IN_FRIENDLY_SHOP
	const EVENT_CLERK_VISIBLE_IN_APRICOT
	const EVENT_OFFICERS_IN_MAGNOLIA
; Vanilla
...
; New to Crystal
	const EVENT_PLAYERS_HOUSE_1F_PROF
	const EVENT_APRICOT_TOWN_ANTIDOTE
	const EVENT_SERENITY_FOREST_REVIVE
	const EVENT_SERENITY_FOREST_X_ATTACK
	const EVENT_SERENITY_FOREST_ANTIDOTE
	const EVENT_SERENITY_FOREST_ETHER
; Vanilla
