...
; SpriteAnimSeqData indexes (see data/sprite_anims/sequences.asm)
	...
	const SPRITE_ANIM_INDEX_MAGNET_TRAIN_PINK         ; 15
	...
	const SPRITE_ANIM_INDEX_PINK_WALK                 ; 2d
...
; SpriteAnimFrameData indexes (see data/sprite_anims/framesets.asm)
	...
	const SPRITE_ANIM_FRAMESET_MAGNET_TRAIN_PINK         ; 1b
	...
	const SPRITE_ANIM_FRAMESET_PINK_WALK                 ; 42
