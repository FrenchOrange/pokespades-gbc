...
Route35NationalParkGate_MapEvents:
	...
	def_warp_events
	warp_event  4,  1, NATIONAL_PARK, 3
	warp_event  5,  1, NATIONAL_PARK, 4
	warp_event  4,  7, ROUTE_35, 3
	warp_event  5,  7, ROUTE_35, 3

	def_coord_events

	def_bg_events
	bg_event  7,  1, BGEVENT_READ, BugCatchingContestExplanationSign

	def_object_events
	object_event  3,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route35OfficerScriptContest, EVENT_ROUTE_35_NATIONAL_PARK_GATE_OFFICER_CONTEST_DAY
