...
Route43MahoganyGate_MapEvents:
	...
	def_warp_events
	warp_event  4,  1, ROUTE_43, 1
	warp_event  5,  1, ROUTE_43, 2
	warp_event  4,  9, MAHOGANY_TOWN, 5
	warp_event  5,  9, MAHOGANY_TOWN, 5
	...
	def_object_events
	object_event  0,  5, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route43MahoganyGateOfficer, -1
