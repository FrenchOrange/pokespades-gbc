...
Route16Gate_MapEvents:
	...
	def_warp_events
	warp_event  0,  3, ROUTE_16, 4
	warp_event  0,  4, ROUTE_16, 5
	warp_event 13,  3, ROUTE_16, 2
	warp_event 13,  4, ROUTE_16, 3

	def_coord_events
	coord_event  6,  4, SCENE_ROUTE16GATE_BICYCLE_CHECK, Route16GateBicycleCheck
	coord_event  6,  5, SCENE_ROUTE16GATE_BICYCLE_CHECK, Route16GateBicycleCheck

	def_bg_events

	def_object_events
	object_event  6,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route16GateOfficerScript, -1
