...
Route36RuinsOfAlphGate_MapEvents:
	...
	def_warp_events
	warp_event  4,  1, ROUTE_36, 3
	warp_event  5,  1, ROUTE_36, 4
	warp_event  4,  9, RUINS_OF_ALPH_OUTSIDE, 9
	warp_event  5,  9, RUINS_OF_ALPH_OUTSIDE, 9
	...
	def_object_events
	object_event  0,  5, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route36RuinsOfAlphGateOfficerScript, -1
	object_event  7,  6, SPRITE_GRAMPS, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Route36RuinsOfAlphGateGrampsScript, -1
