...
Route6SaffronGate_MapEvents:
	...
	def_warp_events
	warp_event  4,  1, SAFFRON_CITY, 12
	warp_event  5,  1, SAFFRON_CITY, 13
	warp_event  4,  9, ROUTE_6, 2
	warp_event  5,  9, ROUTE_6, 2
	...
	def_object_events
	object_event  0,  5, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route6SaffronGuardScript, -1
