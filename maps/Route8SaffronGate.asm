...
Route8SaffronGate_MapEvents:
	...
	warp_event 13,  3, ROUTE_8, 1
	warp_event 13,  4, ROUTE_8, 2
	...
	def_object_events
	object_event  6,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route8SaffronGateOfficerScript, -1
