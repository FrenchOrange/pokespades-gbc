...
Route19FuchsiaGate_MapEvents:
	...
	def_warp_events
	warp_event  4,  1, FUCHSIA_CITY, 10
	warp_event  5,  1, FUCHSIA_CITY, 11
	warp_event  4,  9, ROUTE_19, 1
	warp_event  5,  9, ROUTE_19, 1
	...
	def_object_events
	object_event  0,  5, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route19FuchsiaGateOfficerScript, -1
