...
Route40BattleTowerGate_MapEvents:
	...
	def_warp_events
	warp_event  4,  9, ROUTE_40, 1
	warp_event  5,  9, ROUTE_40, 1
	warp_event  4,  1, BATTLE_TOWER_OUTSIDE, 1
	warp_event  5,  1, BATTLE_TOWER_OUTSIDE, 2
	...
	def_object_events
	object_event  3,  4, SPRITE_ROCKER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route40BattleTowerGateRockerScript, EVENT_BATTLE_TOWER_OPEN_CIVILIANS
	object_event  7,  6, SPRITE_TWIN, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route40BattleTowerGateTwinScript, -1
