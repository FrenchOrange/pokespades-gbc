...
Route34_MapEvents:
	...
	def_warp_events
	warp_event 13, 37, AZALEA_TOWN, 7
	warp_event 14, 37, AZALEA_TOWN, 8
	warp_event 11, 15, DAY_CARE, 1
	warp_event 14, 15, DAY_CARE, 3
	...
	bg_event 10, 16, BGEVENT_READ, DayCareSign
	...
	object_event 16, 16, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DayCareManScript_Outside, EVENT_DAY_CARE_MAN_ON_ROUTE_34
