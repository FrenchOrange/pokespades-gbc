...
CinnabarPokecenter1F_MapEvents:
	...
	warp_event  9,  9, CINNABAR_ISLAND, 1
	...
	def_object_events
	object_event  8,  2, SPRITE_NURSE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CinnabarPokecenter1FNurseScript, -1
