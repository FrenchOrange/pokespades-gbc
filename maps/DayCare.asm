...
DayCare_MapEvents:
	...
	def_warp_events
	warp_event  2,  7, ROUTE_34, 3
	warp_event  3,  7, ROUTE_34, 3
	warp_event  6,  7, ROUTE_34, 4
	warp_event  7,  7, ROUTE_34, 4
	...
	def_object_events
	object_event  3,  4, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DayCareManScript_Inside, EVENT_DAY_CARE_MAN_IN_DAY_CARE
	object_event  6,  4, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, DayCareLadyScript, -1
