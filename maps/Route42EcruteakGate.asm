...
Route42EcruteakGate_MapEvents:
	...
	def_warp_events
	warp_event  0,  3, ECRUTEAK_CITY, 1
	warp_event  0,  4, ECRUTEAK_CITY, 2
	warp_event 13,  3, ROUTE_42, 1
	warp_event 13,  4, ROUTE_42, 2
	...
	def_object_events
	object_event  6,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route42EcruteakGateOfficerScript, -1
