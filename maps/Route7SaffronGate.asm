...
Route7SaffronGate_MapEvents:
	...
	warp_event  0,  4, ROUTE_7, 2
	warp_event 13,  3, SAFFRON_CITY, 10
	warp_event 13,  4, SAFFRON_CITY, 11
	...
	def_object_events
	object_event  6,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route7SaffronGuardScript, -1
