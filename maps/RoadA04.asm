...
RoadA04_MapEvents:
	...
	def_warp_events
	warp_event 12, 27, SERENITY_FOREST, 1
	warp_event 13, 27, SERENITY_FOREST, 2
	warp_event 50,  9, TRAINER_SCHOOL, 1
	warp_event 51,  9, TRAINER_SCHOOL, 2
	warp_event 16,  3, ROAD_A04_MAGNOLIA_GATE, 1
	warp_event 17,  3, ROAD_A04_MAGNOLIA_GATE, 2

	def_coord_events

	def_bg_events
	bg_event 13, 19, BGEVENT_READ, RoadA04Sign
	bg_event 40, 24, BGEVENT_READ, RoadA04TrainerTipsSign
	bg_event 68, 10, BGEVENT_ITEM, RoadA04HiddenPokeBall

	def_object_events
	object_event  5, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RoadA04ParlyzHeal, EVENT_ROAD_A04_PARALYZHEAL
	object_event 17, 21, SPRITE_LASS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerLassSophia, -1
	object_event 31, 18, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_TRAINER, 3, TrainerLadyStacy, -1
	object_event 38, 29, SPRITE_TWIN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_TRAINER, 4, TrainerTwinsAprilandMay1, -1
	object_event 39, 29, SPRITE_TWIN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_TRAINER, 4, TrainerTwinsAprilandMay2, -1
	object_event 48, 21, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RoadA04YoungsterBattle1, -1
	object_event 53, 21, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RoadA04YoungsterBattle2, -1
	object_event 49, 21, SPRITE_RATTATA, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RoadA04MonsterBattle1, -1
	object_event 52, 21, SPRITE_HOOTHOOT, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RoadA04MonsterBattle2, -1
	object_event 66,  9, SPRITE_LITTLE_BOY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RoadA04LittleBoyScript, -1
	object_event 28, 12, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, RoadA04GrannyScript, -1
