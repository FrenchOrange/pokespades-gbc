	...
	const CELADONGAMECORNER_BUG_CATCHER
...
CeladonGameCornerFishingGuruScript:
	...
	waitbutton
	closetext
	turnobject CELADONGAMECORNER_BUG_CATCHER, RIGHT
	end
...
CeladonGameCorner_MapEvents:
	...
	object_event 11,  7, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeladonGameCornerFishingGuruScript, -1
